(() => {
  ...
  function ensureAssets(){
    ...
    loading=new Promise((resolve,reject)=>{
      if(!$('boControlCss')){const l=document.createElement('link');l.id='boControlCss';l.rel='stylesheet';l.href='bo-control-bulk-20260922.css?v=1';document.head.appendChild(l);}
      const s=document.createElement('script');s.src='bo-control-bulk-20260922.js?v=1';s.async=true;s.onload=()=>resolve(window.__boControl);s.onerror=()=>reject(new Error('Falha ao carregar Controle de B.O.'));document.body.appendChild(s);
    });return loading;
  }
