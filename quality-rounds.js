(() => {
 ...
 function render(){
   ...
   root.innerHTML='<div class="quality-module">'+
    ...
    '<section class="quality-grid-secondary"><article class="panel"><div class="panel-heading"><div><h2>Rondas por responsável</h2><small>volume e conformidade individual</small></div></div>'+people(d.by_person)+'</article><article class="panel"><div class="panel-heading"><div><h2>10 piores SKUs</h2><small>maior recorrência em rondas com anomalia</small></div></div>'+bars(d.top_skus,'sku')+'</article></section>'+
