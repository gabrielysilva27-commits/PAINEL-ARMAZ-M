(() => {
  ...
  function render(){
    ...
    root.innerHTML='<div class="policy-v4">'+
      ...
      '<section class="policy-rules"><div><small>Mínimo</small><strong>3 dias</strong><span>estoque de segurança</span></div><div><small>Objetivo</small><strong>5 dias</strong><span>ponto de puxada D+2</span></div><div><small>Máximo médio</small><strong>'+esc(avgMax==null?'—':nf.format(avgMax)+' dias')+'</strong><span>média dos máximos dos SKUs ativos nos últimos 30 dias</span></div><div><small>SKUs ativos</small><strong>'+d.items.length+'</strong><span>na conta do OOR'+esc(activityText)+'</span></div></section>'+
